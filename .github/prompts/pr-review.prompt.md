---
description: "event-reactor: Fetch and triage PR review comments and CI failures for the current branch. Presents findings for approval before handing off to go-fixer."
agent: "pr-reviewer"
...
3. **Coverage check**: Assess patch coverage from Codecov:
   ...
   - The PR comment only shows the top 10 files. To get the **full file list**, fetch the Codecov tree view: `https://app.codecov.io/gh/oakwood-commons/event-reactor/pull/<PR_NUMBER>?dropdown=coverage&src=pr&el=tree`
