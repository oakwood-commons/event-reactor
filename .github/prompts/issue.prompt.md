---
description: "event-reactor: File a GitHub issue with codebase exploration and feasibility assessment."
agent: "agent"
argument-hint: "Describe the change, bug, or feature (e.g., 'Add bash reactor')"
---
